...
from tensorflow.keras.layers import Input, LSTM, Dropout, BatchNormalization, Dense, Multiply, Permute, RepeatVector, Flatten, Activation, Lambda
from tensorflow.keras import backend as K

def build_lstm_branch(time_steps, num_features, units_1=64, units_2=64, dropout_1=0.2, dropout_2=0.2):
