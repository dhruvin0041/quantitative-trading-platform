...
def build_cnn_branch(time_steps, num_features, filters_1=32, filters_2=64, kernel_size=3, dense_units=64):
    """
    ...
    x = Conv1D(filters=filters_1, kernel_size=kernel_size, activation='relu', padding='same')(cnn_input)
