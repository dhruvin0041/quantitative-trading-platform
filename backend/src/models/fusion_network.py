...
def build_fusion_model(config):
    ...
    combined = Concatenate()([lstm_features, cnn_features, transformer_features, peer_features, sentiment_features])
    ...
    model = tf.keras.Model(
        inputs=[ts_input, cnn_input, transformer_input, peer_input, text_input_ids, text_attention_mask], 
