...
class PhysicalEdgeAnalyzer:
    ...
    def get_port_disruption_score(self):
        ...
        try:
            for port, (lat, lon) in self.ports.items():
                ...
                score = 0.0
                if weather_code >= 95: score = 1.0 # Violent
                elif weather_code >= 80: score = 0.7 # Heavy rain/snow
                elif weather_code >= 60: score = 0.4 # Moderate rain
                disruptions.append(score)
            
            avg_disruption = np.mean(disruptions)
    ...
    def get_physical_alpha_vector(self, ticker: str):
        ...
        return {
            ...
            "macro_physical_impact": -disruption * 0.1 # Negative alpha if ports are blocked
        }
